class PagesController < ApplicationController
  ...
  def contact_user
    ...
    if EmailReservation.perform_async(@reservation.user.id, params[:subject], params[:body])
  ...
  def contact_announcer
    @advert = Advert.find(params[:advert])
    if EmailAnnouncer.perform_async(@advert.user, params[:subject], params[:body])
