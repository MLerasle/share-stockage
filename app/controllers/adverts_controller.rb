class AdvertsController < ApplicationController
  ...
  def index
    ...
    my_adverts_address = []
    @adverts.each do |a|
      my_adverts_address << { address: a.full_address, data: a.full_address, tag: "/adverts/#{a.id}" }
    end
  ...
  def advert_params
    params.require(:advert).permit(:address, :area, :price, :advert_type, :city, :user, :validated, :activated, :title, :light, :elevator, :concierge, :car_access, :access_type, :description, :height)
  end
end
